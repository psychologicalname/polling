export default function Home() {
    return (
    <main className="h-full flex items-center justify-center dark:bg-gray-100 bg-transparent py-14">
        <div className="h-fit bg-gray-100 dark:bg-white rounded-lg shadow-lg p-8 max-w-prose">
            ...
            <div>
                <div class="flex items-center px-4 mb-4 border border-gray-200 rounded-lg dark:border-gray-700">
                    ...
                    <label for="option-1" class="w-full py-4 ml-2 text-base font-medium text-gray-500 dark:text-gray-900">Option 1</label>
                </div>
                <div class="flex items-center px-4 mb-4 border border-gray-200 rounded-lg dark:border-gray-700">
                    ...
                    <label for="option-2" class="w-full py-4 ml-2 text-base font-medium text-gray-500 dark:text-gray-900">Option-2</label>
                </div>
            </div>
